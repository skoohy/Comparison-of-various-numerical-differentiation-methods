...
figure(figsize=(11.25,7.5), dpi=300)
plt.plot(x, f(x),    color="black", linewidth=2.5, label="Function")
plt.plot(x, dydx(x), color="red",   linewidth=2.5, label="Functions' Derivative")
...
for dx in dx_values:
    ...
    if 0 in set(analytical):
        ...
        print("Only the absolute error plot will be presented")
    ...
    ##############################################################################################
        # Absolute Error Plot
        figure(figsize=(11.25,7.5), dpi=300)
        plt.plot(x, central_values_abs,  color="black", linewidth=2, label="Central Method")
        plt.plot(x, forward_values_abs,  color="green", linewidth=2, label="Forward Method")
        plt.plot(x, backward_values_abs, color="red",   linewidth=2, label="Backward Method", alpha=0.7)
        plt.xlim(x_end_left, x_end_right)
        plt.yscale("symlog")
    ...
    ##############################################################################################
        # Absolute Error Plot
        figure(figsize=(11.25,7.5), dpi=300)
        plt.semilogy(x, central_values_abs,  color="black", linewidth=2, label="Central Method")
        plt.semilogy(x, forward_values_abs,  color="green", linewidth=2, label="Forward Method")
        plt.semilogy(x, backward_values_abs, color="red",   linewidth=2, label="Backward Method", alpha=0.7)
        plt.xlim(x_end_left, x_end_right)
        plt.grid(True)
        plt.title(f'Absolute Error for Different Numerical Methods $(dx={dx})$')
        plt.legend()
        ...
        # Relative Error Plot
        figure(figsize=(11.25,7.5), dpi=300)
        plt.semilogy(x, central_values_rel,  color="black", linewidth=2, label="Central Method")
        plt.semilogy(x, forward_values_rel,  color="green", linewidth=2, label="Forward Method")
        plt.semilogy(x, backward_values_rel, color="red",   linewidth=2, label="Backward Method", alpha=0.7)
        plt.xlim(x_end_left, x_end_right)
        plt.grid(True)
